...
dU_GC_tidy_Stat_Clean%>%
  ...
  scale_x_continuous(breaks=c(0, 4, 8, 12, 16, 20, 24), expand=c(0,0)) +
  scale_y_continuous(breaks=c(0.01, 0.1, 1.0), expand=c(0,0), trans='log10') +
  coord_cartesian(xlim=c(0,26.5), ylim=c(0.01, 1.6)) + 
  scale_color_manual(values=c("pink", "darkgrey", "red3", "yellow3", "steelblue3", "orange2", "purple3", "green2", "black"), name = "Strain", breaks=c("Blank", "TS559-Parent Strain", "\u0394TK0887-Endonuclease Q", "\u0394TK1898-Endonuclease MS", "\u0394TK2143-Uracil DNA Glycosylase","\u0394TK0887/\u0394TK1898", "\u0394TK0887/\u0394TK2143", "\u0394TK1898/\u0394TK2143", "\u0394TK0887/\u0394TK1898/\u0394TK2143"))+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  facet_wrap(~Strain) +
...
theme(legend.position = "none") +
  theme(plot.title = element_text(family = '', face = 'bold', size = 12),
        ...
        axis.text = element_text(family = "", size = 6, face = 'bold', color = "black"),
        legend.title = element_blank(),
        legend.text = element_text(family = '', face = 'bold', size = 11)) 

ggsave("dU_Plot_85_Log.jpg", dpi=2000, height=5)

dU_GC_tidy_Stat_Clean_95 <- dU_GC_tidy_Stat_95[-(which(dU_GC_tidy_Stat_95$Strain %in% "Blank" )),]

dU_GC_tidy_Stat_Clean_95%>%
  ggplot(aes(x=Hours, y=mean, color=Strain, ymax=mean+se, ymin=mean-se)) +
  geom_line(size=0.5) +
  geom_point(size=1.2) +
  geom_errorbar(width=0.1) +
  theme_bw() +
  labs(title = bquote(bold("Only deletion of all dU repair components impacts growth")), subtitle=bquote(bold("95\u00B0C")),
       y = bquote(bold("OD")[600][nm]),
       x = bquote(bold('Time (Hours)'))) +
  theme(plot.title = element_text(hjust = 0.5), plot.subtitle= element_text(hjust =   0.5)) +
  scale_x_continuous(breaks=c(0, 4, 8, 12, 16, 20, 24), expand=c(0,0)) +
...
ggsave("dU_Plot_95_Log.jpg", dpi=2000, height=5)

...
Try plotting mean (optical density) against time now. 
...
Try combining a line graph and scatter plot, but make sure the points are visible for each line.
...
Lets rescale the x axis tick marks to be more helpful. Try to get it to label 4 hours.
Try also rescaling the y axis so we have context for where the maximum OD is.
...
See the difference in putting the theme before or after the line of code
